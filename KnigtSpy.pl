...
sub help {
    ...
    print color("bold white"),"perl KnightSpy.pl -i example.com\n";
    print item('2'),"Phone Number Information ";
    print color('bold red'),"=> ";
    print color("bold white"),"perl KnightSpy.pl -n xxxxxxx\n";
    print item('3'),"Find IP Address And E-mail Server ";
    print color('bold red'),"=> ";
    print color("bold white"),"perl KnightSpy.pl -mx example.com\n";
    print item('4'),"Domain Whois Lookup ";
    print color('bold red'),"=> ";
    print color("bold white"),"perl KnightSpy.pl -w example.com\n";
    print item('5'),"Find Website/IP Address Location ";
    print color('bold red'),"=> ";
    print color("bold white"),"perl KnightSpy.pl -l example.com\n";
    print item('6'),"Bypass CloudFlare ";
    print color('bold red'),"=> ";
    print color("bold white"),"perl KnightSpy.pl -c example.com\n";
    print item('7'),"Domain Age Checker ";
    print color('bold red'),"=> ";
    print color("bold white"),"perl KnightSpy.pl -a example.com\n";
    print item('8'),"User Agent Info ";
    print color('bold red'),"=> ";
    print color("bold white"),"perl KnightSpy.pl -ua Mozilla/5.0 xxxxxxxxxxxxxxxxxxxx\n";
    print item('9'),"Check Active Services On Resource";
    print color('bold red'),"=> ";
    print color("bold white"),"perl KnightSpy.pl -p 127.0.0.1\n";
    print item('10'),"Credit Card Bin Checker ";
    print color('bold red'),"=> ";
    print color("bold white"),"perl KnightSpy.pl -b 123456\n";
    print item('11'),"Subdomain Scanner ";
    print color('bold red'),"=> ";
    print color("bold white"),"perl KnightSpy.pl -s example.com\n";
    print item('12'),"E-mail Address Checker ";
    print color('bold red'),"=> ";
    print color("bold white"),"perl KnightSpy.pl -e example@gmail.com\n";
    print item('13'),"Content Management System Checker ";
    print color('bold red'),"=> ";
    print color("bold white"),"perl KnightSpy.pl -cms example.com\n";
}
...
sub banner {
  ...
  print "    ,` -.)\n";
  print "   ( _/-\\-._\n";
  print "  /,|`--._,-^|            ,    __ __       _       __    __  _____ \n";
  print "  \_| |`-._/||          ,'|   / //_/____  (_)___ _/ /_  / /_/ ___/____  __  __ \n";
  print "    |  `-, / |         /  /  / ,<  / __ \/ / __ `/ __ \/ __/\__ \/ __ \/ / / / \n";
  print "    |     || |        /  /  / /| |/ / / / / /_/ / / / / /_ ___/ / /_/ / /_/ /  \n";
 print "      `r-._||/   __   /  /  /_/ |_/_/ /_/_/\__, /_/ /_/\__//____/ .___/\__, /   \n";
...
print color('bold green'),"V 2.0\n";
print color('reset');
print " \033[0;31m[\033[0;37mCoded BY hackelite01 (Mayank Rajput)\033[0;31m]\033[0;37m\n";
...
my %seen;
    ...
    $maraj = $response->content;

    if($maraj =~m/">(.*?)<\/a>&nbsp/g){
        print item(),"Real IP: $1\n";
        $ip=$1;
    }elsif($maraj =~m/not CloudFlare-user nameservers/g){
        print item(),"These Are Not CloudFlare-user Nameservers !!\n";
        print item(),"This Website Not Using CloudFlare Protection\n";
    }elsif($maraj =~m/No direct-connect IP address was found for this domain/g){
...
sub update {
    if ($^O =~ /MSWin32/) {
        banner();
        print item('1'),"Download KnightSpy\n";
        print item('2'),"Extract KnightSpy into Desktop\n";
        print item('3'),"Open CMD and type the following commands:\n";
        print item('4'),"cd Desktop/KnightSpy-master/\n";
        print item('5'),"perl KnightSpy.pl\n";
    }else {
        $linux = "/usr/share/KnightSpy";
        $termux = "/data/data/com.termux/files/usr/share/KnightSpy";
        if (-d $linux){
            system("bash /usr/share/KnightSpy/update.sh");
        } elsif (-d $termux){
            system("chmod +x /data/data/com.termux/files/usr/share/KnightSpy/update.sh && bash /data/data/com.termux/files/usr/share/KnightSpy/update.sh");
        }
    }
}
##### Enter #######
